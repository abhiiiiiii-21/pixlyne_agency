...
const useHoverVideoPlayer = () => {
  ...
  if (!context) {
    throw new Error("useHoverVideoPlayer must be used within a HoverVideoPlayer")
  }
  return context
}
...
const HoverVideoPlayer = ({
  ...
  useEffect(() => {
    ...
    if (state.isMobile) {
      ...
      console.log("Hovering, scheduling playback with delay:", playbackStartDelay)
 ...
 */
const HoverVideoPlayerVideo = ({ src, unloadVideoOnPaused, loop, preload }) => {
 ...
 */
const HoverVideoPlayerThumbnail = ({ src }) => {
 ...
 */
const HoverVideoPlayerControls = ({
  children,
}) => {
 ...
 */
const HoverVideoPlayerHoverOverlay = ({
  children,
}) => {
 ...
 */
const HoverVideoPlayerPausedOverlay = ({ children }) => {
 ...
 */
const HoverVideoPlayerLoadingOverlay = ({ children }) => {
 ...
 */
const HoverVideoPlayerPlayPauseButton = () => {
 ...
 */
const HoverVideoPlayerVolumeControl = () => {
 ...
 */
const HoverVideoPlayerProgressBar = () => {
 ...
 */
const HoverVideoPlayerPiPButton = () => {
 ...
 */
const HoverVideoPaddingWrapper = ({ width, height, className, children }) => {
  return (
    <div
      style={{
        "--width": width,
      ...
      <div
        className="absolute -inset-[var(--padding)] rounded-[calc(var(--radius)+var(--padding))] shadow-sm ring-1 ring-black/5 [--padding:theme(spacing.2)]" />
      {children}
    </div>
  );
}
