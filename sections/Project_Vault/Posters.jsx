"use client";
import { posters } from '@/data/Posters/posters';
    ...
    return (
        <>
            <motion.div 
                ...
                animate="visible"
            >
                {posters.map(({title, thumbnail}, index) => (
                    <motion.div
                        key={index}
                ...
                {selectedImage && (
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            onClick={() => setSelectedImage(null)}
                            className="absolute top-4 right-4 bg-white/10 hover:bg-white/20 text-white p-3 rounded-full transition-all hover:rotate-90 duration-300 backdrop-blur-sm border border-white/20"
                        >
